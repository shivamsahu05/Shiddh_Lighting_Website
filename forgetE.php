...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['btn2'])) {
    ...
    if ($result->num_rows == 1) {
        ...
        header('Location: updatepassE.php'); 
        exit;
    } else {
...
<head>
    ...
    <title>Forget Password via Email</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="main">
        <div class="box">
            ...
            <a href="forgetM.php" class="link">Try Another Way?</a>
            <form id="password-reset-form" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
                <input type="email" name="t1" id="email" placeholder="Enter Email Address" required>
